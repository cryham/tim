...
#define NumTemp  4  // count
// 14,15,16,17 - ADC from Thermocouple op-amps
extern const uint8_t ADC_Temp[NumTemp];

//  Temperature 'C sensor DS18B20
#define TEMP1  18		//  44   9%  24k

//  led light-
//#define LED  12

//----  Used pins:  ----
//  Fans 7*2 + Keys 3+3 + Lcd SPI 5+1 led + 4 ADC T + 1 T'C
//  = 14 + 6 + 6 = 26
